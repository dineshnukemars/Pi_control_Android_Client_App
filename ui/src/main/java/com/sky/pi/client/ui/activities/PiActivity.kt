package com.sky.pi.client.ui.activities
...
import com.sky.pi.client.libs.livedata.observeIfNotNull
import com.sky.pi.client.ui.R
import com.sky.pi.client.ui.fragments.PinInfoFragment
import com.sky.pi.client.ui.fragments.PinSetupFragment
...
class PiActivity : AppCompatActivity() {
    ...
    private fun setupUI() {
        ...
        bottomNav_view.setOnNavigationItemSelectedListener { item: MenuItem ->
            when (item.itemId) {
